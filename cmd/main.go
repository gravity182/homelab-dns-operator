...
// Package main registers the controllers and bootstraps the manager.
package main
...
import (
	...
	"github.com/gravity182/gateway-dns-operator/internal/controller"
...
func loadConfig() (config, error) {
	...
	if username != "" {
		cfg.adguardAuth = &adguard.BasicAuth{
			Username: username,
			Password: password,
		}
	}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1b03dbfb.jellywatch.dev",
